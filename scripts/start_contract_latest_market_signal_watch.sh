...
UPDATE_STATE_JSON="${CONTRACT_MARKET_UPDATE_STATE_JSON:-artifacts/v9/watchdog/binance_usdm_ohlcv_top20_${TIMEFRAME_SAFE}_update_status.json}"
SIGNAL_JSON="${CONTRACT_MARKET_SIGNAL_JSON:-artifacts/v9/contract_lab/contract_latest_market_signal_${TIMEFRAME_SAFE}_latest.json}"
SIGNAL_MD="${CONTRACT_MARKET_SIGNAL_MD:-artifacts/v9/contract_lab/contract_latest_market_signal_${TIMEFRAME_SAFE}_latest.md}"
JOURNAL_JSONL="${CONTRACT_MARKET_JOURNAL_JSONL:-state/contract_latest_market_signal_${TIMEFRAME_SAFE}_journal.jsonl}"
MARKER="${CONTRACT_MARKET_MARKER:-state/FOUND_CONTRACT_MARKET_${TIMEFRAME_SAFE}_PAPER_PLAN.txt}"
NO_MARKER="${CONTRACT_MARKET_NO_MARKER:-state/NO_CONTRACT_MARKET_${TIMEFRAME_SAFE}_PAPER_PLAN.txt}"
ANALOG_MARKER="${CONTRACT_MARKET_ANALOG_MARKER:-state/FOUND_CONTRACT_MARKET_${TIMEFRAME_SAFE}_ANALOG_PAPER_PLAN.txt}"
ANALOG_NO_MARKER="${CONTRACT_MARKET_ANALOG_NO_MARKER:-state/NO_CONTRACT_MARKET_${TIMEFRAME_SAFE}_ANALOG_PAPER_PLAN.txt}"
