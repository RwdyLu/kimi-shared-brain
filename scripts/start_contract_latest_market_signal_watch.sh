...
JOURNAL_SHADOW_VETO_MODE="${CONTRACT_MARKET_JOURNAL_SHADOW_VETO_MODE:-pair_or_regime}"
JOURNAL_SHADOW_VETO_MIN_COMPLETED="${CONTRACT_MARKET_JOURNAL_SHADOW_VETO_MIN_COMPLETED:-3}"
JOURNAL_SHADOW_VETO_MAX_SUM_R="${CONTRACT_MARKET_JOURNAL_SHADOW_VETO_MAX_SUM_R:--1.0}"
JOURNAL_SHADOW_VETO_MAX_PROFIT_FACTOR="${CONTRACT_MARKET_JOURNAL_SHADOW_VETO_MAX_PROFIT_FACTOR:-0.8}"
JOURNAL_SHADOW_VETO_MIN_LOSS_RATE="${CONTRACT_MARKET_JOURNAL_SHADOW_VETO_MIN_LOSS_RATE:-0.67}"
...
case "$JOURNAL_SHADOW_VETO_MODE" in
  off|pair|pair_or_regime) ;;
  *)
    echo "CONTRACT_MARKET_JOURNAL_SHADOW_VETO_MODE must be off, pair, or pair_or_regime" >&2
    exit 2
    ;;
esac
...
printf -v JOURNAL_SHADOW_VETO_MODE_Q "%q" "$JOURNAL_SHADOW_VETO_MODE"
printf -v JOURNAL_SHADOW_VETO_MIN_COMPLETED_Q "%q" "$JOURNAL_SHADOW_VETO_MIN_COMPLETED"
printf -v JOURNAL_SHADOW_VETO_MAX_SUM_R_Q "%q" "$JOURNAL_SHADOW_VETO_MAX_SUM_R"
printf -v JOURNAL_SHADOW_VETO_MAX_PF_Q "%q" "$JOURNAL_SHADOW_VETO_MAX_PROFIT_FACTOR"
printf -v JOURNAL_SHADOW_VETO_MIN_LOSS_RATE_Q "%q" "$JOURNAL_SHADOW_VETO_MIN_LOSS_RATE"
...
echo "journal_shadow_veto: mode=$JOURNAL_SHADOW_VETO_MODE min_completed=$JOURNAL_SHADOW_VETO_MIN_COMPLETED max_sum_R=$JOURNAL_SHADOW_VETO_MAX_SUM_R max_pf=$JOURNAL_SHADOW_VETO_MAX_PROFIT_FACTOR min_loss_rate=$JOURNAL_SHADOW_VETO_MIN_LOSS_RATE"
