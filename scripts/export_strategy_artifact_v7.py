...
def export_artifact(candidate: dict[str, Any], approval_row: dict[str, Any] | None, archive_path: Path, approval_path: Path | None, data_audit_path: Path, out_root: Path, tag: str) -> Path:
