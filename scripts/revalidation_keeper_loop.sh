...
STATUS_GROUPS="${REVALIDATION_KEEPER_STATUS_GROUPS:-25}"
COMMAND_TIMEOUT_SEC="${REVALIDATION_KEEPER_COMMAND_TIMEOUT_SEC:-120}"
STOP_POLL_SEC="${REVALIDATION_KEEPER_STOP_POLL_SEC:-30}"
RUNNER_MAX_PYTHON_FACTORY="${REVALIDATION_RUNNER_MAX_PYTHON_FACTORY:-4}"
...
HOLDOUT_AUDITOR_MAX_GROUPS="${REVALIDATION_HOLDOUT_AUDITOR_MAX_GROUPS:-25}"
