...
class ConfigManager:
    ...
    def _load_from_env(self):
        ...
        self.trading.max_position_size = float(
            os.getenv('MAX_POSITION_SIZE', self.trading.max_position_size)
        )
        self.trading.max_drawdown_pct = float(
            os.getenv('MAX_DRAWDOWN', self.trading.max_drawdown_pct)
        )
