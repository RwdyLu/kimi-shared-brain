...
def health():
    ...
    return (
        jsonify(
            {"status": "healthy", "service": "github-webhook", "port": WEBHOOK_PORT, "time": datetime.now().isoformat()}
        ),
        200,
    )
        ...
        jsonify(
            {
                ...
                "version": "1.0",
                "endpoints": {"/webhook": "POST - Receive GitHub webhooks", "/health": "GET - Health check"},
