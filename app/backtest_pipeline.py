...
class BacktestPipeline:
    ...
    def run_backtest(self,
        ...
        try:
            ...
            self.logger.info(
                f"Backtest complete: {backtest_id} "
    ...
    def run_batch(self,
                 configs: List[Dict],
                 strategy_func: Callable,
                 data: List[Dict]) -> List[BacktestResult]:
        """
    ...
    def compare_results(self,
                       backtest_ids: Optional[List[str]] = None) -> Dict:
        """
        ...
        if backtest_ids is None:
            backtest_ids = [
                bid for bid, bt in self.backtests.items()
    ...
    def export_report(self, filepath: str):
        ...
        completed = [
            bt.to_dict() for bt in self.backtests.values()
            if bt.status == BacktestStatus.COMPLETED
        ]
