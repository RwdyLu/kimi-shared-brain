...
class DataExporter:
    ...
    def export_data(self, data: List[Dict], filepath: str, format: ExportFormat = ExportFormat.JSON) -> bool:
        """
        Export data to file.
    ...
    def create_backup(self, sources: List[str], label: str = "") -> Optional[str]:
        """
...
if __name__ == "__main__":
    ...
    # Backup
    backup_path = exporter.create_backup(sources=["state/tasks.json", "outbox/"], label="daily")
