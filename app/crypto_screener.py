...
class CryptoScreener:
    ...
    def get_breakout_candidates(self,
                             min_volume_change: float = 50.0) -> List[CoinData]:
        """
    ...
    def get_trending(self,
                    min_change: float = 5.0) -> List[CoinData]:
        """
        Find trending coins.
        ...
        """
        return [
            c for c in self.screened
            if c.price_change_24h >= min_change
        ]
    
    def get_undervalued(self,
                       max_change: float = -5.0) -> List[CoinData]:
        """
        ...
        return [
            c for c in self.screened
            if c.price_change_24h <= max_change
            and c.market_cap > 100000000  # $100M+ market cap
        ]
