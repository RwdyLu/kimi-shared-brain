...
class AutoStrategyLoop:
    ...
    def __init__(self, check_interval: int = 60, max_concurrent: int = 5):
    ...
    def register_strategy(self, strategy_id: str, run_func: Callable, interval_minutes: int = 60):
        """
    ...
    def _execute_cycle(self):
        """Execute one cycle."""
        self.cycle_count += 1
        cycle = ExecutionCycle(cycle_id=self.cycle_count, start_time=datetime.now())
