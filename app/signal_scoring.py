...
class SignalQualityScorer:
    ...
    def score_signal(
        ...
        """
        quality = SignalQuality(signal_id=signal_id, symbol=symbol, strategy=strategy, side=side)
        ...
        quality.scores = [
            ...
            SignalScore(
                ...
                volatility_data.get("atr_percent", 0),
            ),
            SignalScore(
                "Volume",
                volume_score,
                self.weights["volume"],
                "Volume confirmation",
                volume_data.get("volume_ratio", 1.0),
            ),
            SignalScore(
                "Sentiment",
                sentiment_score,
...
if __name__ == "__main__":
    ...
    quality = scorer.score_signal(
        ...
        strategy="BTC_4H_MA",
        side="buy",
        trend_data={"trend_strength": 0.8, "trend_direction": 1, "signal_alignment": 0.9},
        momentum_data={"rsi": 65, "macd_signal": 0.7},
        volatility_data={"atr_percent": 1.5, "regime": "normal"},
        volume_data={"volume_ratio": 1.8, "volume_trend": 0.5},
        sentiment_data={"sentiment_score": 0.6, "sentiment_trend": 0.3},
        risk_data={"risk_reward": 2.5, "max_loss": 100, "account_risk_percent": 0.02},
    )
