...
EVALUATION_VERSION_BY_PRESET = {
    ...
    "hq_wf_hostile_bridge": "selection_validation_v1_xsec_hq_walkforward_hostile_bridge",
    "hq_wf_hostile_hedged": "selection_validation_v1_xsec_hq_walkforward_hostile_hedged",
