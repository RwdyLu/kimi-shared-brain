...
ROW_CACHE_VERSION = "tsmom_factory_v2_walkforward_symbol_leg"
...
def config_for_preset(
    ...
    if preset == "slow_cost_guard":
        return RunConfig(
            lookbacks_h=(720, 1440, 2160, 4320),
            preset_configs=slow_cost_guard_configs(),
            **base,
        )
    if preset == "ultra_slow_cost_guard":
        return RunConfig(
            lookbacks_h=(720, 1440, 2160, 4320),
            preset_configs=ultra_slow_cost_guard_configs(),
            **base,
        )
    if preset == "core_cost_guard":
        return RunConfig(
            symbols=CORE_TREND_SYMBOLS,
            lookbacks_h=(336, 720, 1440, 2160),
            preset_configs=core_cost_guard_configs(),
            **base,
        )
    if preset == "core_slow_cost_guard":
        return RunConfig(
            symbols=CORE_TREND_SYMBOLS,
            lookbacks_h=(720, 1440, 2160, 4320),
            preset_configs=core_cost_guard_configs(),
...
def slow_cost_guard_configs() -> tuple[TsmomConfig, ...]:
    return (
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.08, 0.30, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.35, 0.06, 0.30, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.50, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.50, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.08, 0.30, market_filter_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.50, market_filter_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=1440, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=1440, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=720, drawdown_stop=0.12, cooldown_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=720, drawdown_stop=0.12, cooldown_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
    )


def ultra_slow_cost_guard_configs() -> tuple[TsmomConfig, ...]:
    return (
        TsmomConfig(0.25, 0.03, 0.30, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.05, 0.30, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.50, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.05, 0.50, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.70, market_filter_h=1440, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=2160, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.05, 0.30, market_filter_h=2160, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.03, 0.30, market_filter_h=1440, bear_mode="short_weak", bear_short_scale=0.05, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=1440, bear_mode="short_weak", bear_short_scale=0.05, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.05, 0.30, market_filter_h=1440, bear_mode="short_weak", bear_short_scale=0.05, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.04, 0.50, market_filter_h=1440, bear_mode="short_weak", bear_short_scale=0.05, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=2160, bear_mode="short_weak", bear_short_scale=0.05, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.05, 0.30, market_filter_h=2160, bear_mode="short_weak", bear_short_scale=0.05, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=1440, drawdown_stop=0.10, cooldown_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=1440, drawdown_stop=0.10, cooldown_h=720, bear_mode="short_weak", bear_short_scale=0.05, short_vote_threshold=0.25),
    )


def core_cost_guard_configs() -> tuple[TsmomConfig, ...]:
    return (
        TsmomConfig(0.25, 0.04, 0.20, market_filter_h=336, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.20, market_filter_h=336, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.08, 0.20, market_filter_h=336, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=336, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.04, 0.20, market_filter_h=336, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.20, market_filter_h=336, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.08, 0.20, market_filter_h=336, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=336, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.04, 0.30, market_filter_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.30, market_filter_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
        TsmomConfig(0.25, 0.06, 0.20, market_filter_h=336, drawdown_stop=0.12, cooldown_h=720, bear_mode="flat", bear_short_scale=0.0),
        TsmomConfig(0.25, 0.06, 0.20, market_filter_h=336, drawdown_stop=0.12, cooldown_h=720, bear_mode="short_weak", bear_short_scale=0.10, short_vote_threshold=0.25),
    )
...
def simulate(
    ...
    long_daily_returns = (1.0 + ret["long_gross_return"]).resample("1D").prod() - 1.0
    short_daily_returns = (1.0 + ret["short_gross_return"]).resample("1D").prod() - 1.0
    ...
    return {
        ...
        "legs": {
            ...
            "long_gross_sharpe": sharpe(long_daily_returns, 365.0),
            "short_gross_return": short_gross_return,
            "short_gross_sharpe": sharpe(short_daily_returns, 365.0),
            "avg_long_exposure": float(ret["long_exposure"].mean()) if len(ret) else 0.0,
            "avg_short_exposure": float(ret["short_exposure"].mean()) if len(ret) else 0.0,
        },
...
def walk_forward_summary(
    ...
    min_rows = max(max(lookbacks_h) + 48, 240)
    ...
    for fold in range(usable_folds):
        ...
        if len(frame) < min_rows:
            continue
        result = simulate(frame, cfg, lookbacks_h, cost_bps, bootstrap_iterations=0)
    ...
    return {
        ...
        "checks": checks,
        "folds": rows,
        "note": "Train-only purged-style fold robustness; it does not authorize holdout, paper trading, or live trading.",
    }
...
def leave_one_symbol_summary(
    ...
    return {
        ...
        "checks": checks,
        "rows": rows,
        "note": "Train-only leave-one-symbol robustness; it does not authorize holdout, paper trading, or live trading.",
    }
...
def run_grid(cfg: RunConfig) -> dict[str, Any]:
    ...
    for g in grid:
        ...
        if selection_passed:
            walk_forward = walk_forward_summary(selection_closes, g, cfg.lookbacks_h, cost_bps=40.0)
        ...
        if should_validate:
            ...
            leave_one_symbol = leave_one_symbol_summary(validation_closes, g, cfg.lookbacks_h, cost_bps=40.0)
            ...
            val_checks["validation_short_leg_gross_return_gt_minus_5pct"] = (
                float(val40_legs.get("avg_short_exposure", 0.0) or 0.0) <= 0.01
                or float(val40_legs.get("short_gross_return", 0.0) or 0.0) > -0.05
            )
        else:
            val20 = {}
            val40 = {}
...
def write_markdown(payload: dict[str, Any], path: Path) -> None:
    ...
    lines.extend(
        [
            ...
            "## Top Rows",
            "",
            "| cfg | pass | sel 20bps sh | wf q25 40bps | val 20bps sh | val ret | val DD | sel boot p5 | symbols+ | turnover | drop-one | loo min sh |",
            "|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|",
        ]
    )
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument(
        ...
        choices=(
            ...
            "slow_cost_guard",
            "ultra_slow_cost_guard",
            "core_cost_guard",
            "core_slow_cost_guard",
        ),
        default="core",
    )
